...
![Parents](2-Mechanics/CLI/tables/parents-xge.md)

![Half-Elf Parents](2-Mechanics/CLI/tables/half-elf-parents-xge.md)

![Half-Orc Parents](2-Mechanics/CLI/tables/half-orc-parents-xge.md)

![Tiefling Parents](2-Mechanics/CLI/tables/tiefling-parents-xge.md)
...
![Birthplace](2-Mechanics/CLI/tables/birthplace-xge.md)
...
![Number of Siblings](2-Mechanics/CLI/tables/number-of-siblings-xge.md)

![Other Details; Birth Order](2-Mechanics/CLI/tables/other-details-birth-order-xge.md)
...
![](2-Mechanics/CLI/books/xanathars-guide-to-everything/img/c1040.webp#center)
...
![Supplemental Tables; Family](2-Mechanics/CLI/tables/supplemental-tables-family-xge.md)

![Supplemental Tables; Absent Parent](2-Mechanics/CLI/tables/supplemental-tables-absent-parent-xge.md)

![Supplemental Tables; Family Lifestyle](2-Mechanics/CLI/tables/supplemental-tables-family-lifestyle-xge.md)

![Supplemental Tables; Childhood Home](2-Mechanics/CLI/tables/supplemental-tables-childhood-home-xge.md)
...
![](2-Mechanics/CLI/books/xanathars-guide-to-everything/img/c1043.webp#center)
...
![Life Events by Age](2-Mechanics/CLI/tables/life-events-by-age-xge.md)

![Life Events](2-Mechanics/CLI/tables/life-events-xge.md)

#### Secondary Tables

These tables add detail to many of the results on the Life Events table. The tables are in alphabetical order.

![Secondary Tables; Adventures](2-Mechanics/CLI/tables/secondary-tables-adventures-xge.md)

![Secondary Tables; Arcane Matters](2-Mechanics/CLI/tables/secondary-tables-arcane-matters-xge.md)

![Secondary Tables; Boons](2-Mechanics/CLI/tables/secondary-tables-boons-xge.md)

![Secondary Tables; Crime](2-Mechanics/CLI/tables/secondary-tables-crime-xge.md)

![Secondary Tables; Punishment](2-Mechanics/CLI/tables/secondary-tables-punishment-xge.md)

![Secondary Tables; Supernatural Events](2-Mechanics/CLI/tables/secondary-tables-supernatural-events-xge.md)

![Secondary Tables; Tragedies](2-Mechanics/CLI/tables/secondary-tables-tragedies-xge.md)

![Secondary Tables; War](2-Mechanics/CLI/tables/secondary-tables-war-xge.md)

![Secondary Tables; Weird Stuff](2-Mechanics/CLI/tables/secondary-tables-weird-stuff-xge.md)
...
![](2-Mechanics/CLI/books/xanathars-guide-to-everything/img/c1044.webp#center)

![Supplemental Tables; Alignment](2-Mechanics/CLI/tables/supplemental-tables-alignment-xge.md)

![Supplemental Tables; Cause of Death](2-Mechanics/CLI/tables/supplemental-tables-cause-of-death-xge.md)

![Supplemental Tables; Class](2-Mechanics/CLI/tables/supplemental-tables-class-xge.md)

![Supplemental Tables; Occupation](2-Mechanics/CLI/tables/supplemental-tables-occupation-xge.md)

![Supplemental Tables; Race](2-Mechanics/CLI/tables/supplemental-tables-race-xge.md)

![Supplemental Tables; Relationship](2-Mechanics/CLI/tables/supplemental-tables-relationship-xge.md)

![Supplemental Tables; Status](2-Mechanics/CLI/tables/supplemental-tables-status-xge.md)
