...
The rule for falling assumes that a creature immediately drops the entire distance when it falls. But what if a creature is at a high altitude when it falls, perhaps on the back of a [griffon](2-Mechanics/CLI/bestiary/monstrosity/griffon-xmm.md) or on board an [airship](2-Mechanics/CLI/items/airship-xphb.md)? Realistically, a fall from such a height can take more than a few seconds, extending past the end of the turn when the fall occurred. If you'd like high-altitude falls to be properly time-consuming, use the following optional rule.

When you fall from a great height, you instantly descend up to 500 feet. If you're still falling on your next turn, you descend up to 500 feet at the end of that turn. This process continues until the fall ends, either because you hit the ground or the fall is otherwise halted.

### Flying Creatures and Falling

A flying creature in flight falls if it is knocked [prone](2-Mechanics/CLI/rules/conditions.md#Prone), if its speed is reduced to 0 feet, or if it otherwise loses the ability to move, unless it can hover or it is being held aloft by magic, such as the [fly](2-Mechanics/CLI/spells/fly-xphb.md) spell.
...
![](2-Mechanics/CLI/books/xanathars-guide-to-everything/img/c2001.webp#center)
...
![](2-Mechanics/CLI/rules/variant-rules/img/xge-001.webp#center)
...
![](2-Mechanics/CLI/rules/variant-rules/img/xge-002.webp#center)

![](2-Mechanics/CLI/rules/variant-rules/img/xge-003.webp#center)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 11th-15th Level](2-Mechanics/CLI/tables/determine-numbers-and-challenge-ratings-multiple-monsters-11th-15th-level-xge.md)
...
![](2-Mechanics/CLI/books/xanathars-guide-to-everything/img/c2005.webp#center)
...
![](2-Mechanics/CLI/books/xanathars-guide-to-everything/img/c2021.webp#center)
...
![](2-Mechanics/CLI/books/xanathars-guide-to-everything/img/c2022.webp#center)
...
![Level and Lethality; Trap Save DCs and Attack Bonuses](2-Mechanics/CLI/tables/level-and-lethality-trap-save-dcs-and-attack-bonuses-xge.md)
...
Once you determine how a trap can be disarmed or avoided, decide the appropriate ability and skill combinations that characters can use. A Dexterity check using [thieves' tools](2-Mechanics/CLI/items/thieves-tools-xphb.md), a Strength ([Athletics](2-Mechanics/CLI/rules/skills.md#Athletics)) check, and an Intelligence ([Arcana](2-Mechanics/CLI/rules/skills.md#Arcana)) check are all commonly used for this purpose.

A Dexterity check using [thieves' tools](2-Mechanics/CLI/items/thieves-tools-xphb.md) can apply to any trap that has a mechanical element. [Thieves' tools](2-Mechanics/CLI/items/thieves-tools-xphb.md) can be used to disable a trip wire or a pressure plate, disassemble a poison needle mechanism, or clog a valve that leaks poisonous gas into a room.
...
![](2-Mechanics/CLI/books/xanathars-guide-to-everything/img/c2024.webp#center)
...
![](2-Mechanics/CLI/books/xanathars-guide-to-everything/img/c2025.webp#center)
...
A character with the noble background can mingle with the upper class, but other characters can do so only if you judge that the character has made sufficient contacts. Alternatively, a character might use a [disguise kit](2-Mechanics/CLI/items/disguise-kit-xphb.md) and the [Deception](2-Mechanics/CLI/rules/skills.md#Deception) skill to pass as a noble visiting from a distant city.
...
![Lower-Class Carousing Complications](2-Mechanics/CLI/tables/lower-class-carousing-complications-xge.md)
...
![](2-Mechanics/CLI/books/xanathars-guide-to-everything/img/c2026.webp#center)
...
![Crafting Magic Items; Magic Item Ingredients](2-Mechanics/CLI/tables/crafting-magic-items-magic-item-ingredients-xge.md)
...
To attempt a crime, the character makes three checks: Dexterity ([Stealth](2-Mechanics/CLI/rules/skills.md#Stealth)), Dexterity using [thieves' tools](2-Mechanics/CLI/items/thieves-tools-xphb.md), and the player's choice of Intelligence ([Investigation](2-Mechanics/CLI/rules/skills.md#Investigation)), Wisdom ([Perception](2-Mechanics/CLI/rules/skills.md#Perception)), or Charisma ([Deception](2-Mechanics/CLI/rules/skills.md#Deception)).
...
![](2-Mechanics/CLI/books/xanathars-guide-to-everything/img/c2027.webp#center)
...
A character who wants to sell an item must make a Charisma ([Persuasion](2-Mechanics/CLI/rules/skills.md#Persuasion)) check to determine what kind of offer comes in. The character can always opt not to sell, instead forfeiting the workweek of effort and trying again later. Use the Magic Item Base Prices and Magic Item Offer tables to determine the sale price.

![Selling a Magic Item; Magic Item Base Prices](2-Mechanics/CLI/tables/selling-a-magic-item-magic-item-base-prices-xge.md)

![Selling a Magic Item; Magic Item Offer](2-Mechanics/CLI/tables/selling-a-magic-item-magic-item-offer-xge.md)
...
![Magic Item Sale Complications](2-Mechanics/CLI/tables/magic-item-sale-complications-xge.md)

![](2-Mechanics/CLI/books/xanathars-guide-to-everything/img/c2028.webp#center)
...
![Training Complications](2-Mechanics/CLI/tables/training-complications-xge.md)
