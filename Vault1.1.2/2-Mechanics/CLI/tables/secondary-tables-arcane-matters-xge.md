...
|-----------|---------------|
| 1 | You were [charmed](2-Mechanics/CLI/rules/conditions.md#Charmed) or [frightened](2-Mechanics/CLI/rules/conditions.md#Frightened) by a spell. |
...
| 7 | You turned [invisible](2-Mechanics/CLI/rules/conditions.md#Invisible) for a time. |
