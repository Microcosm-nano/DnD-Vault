...
*Use this column for [Cylinders](2-Mechanics/CLI/rules/variant-rules/cylinder-area-of-effect-xphb.md), [Emanations](2-Mechanics/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) (using the size of the Emanation rather than its radius), and [Spheres](2-Mechanics/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md).