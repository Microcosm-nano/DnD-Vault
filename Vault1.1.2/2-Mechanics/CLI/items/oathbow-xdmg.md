...
![](2-Mechanics/CLI/items/img/oathbow.webp#right)
...
When you make a ranged attack roll with this weapon against your sworn enemy, you have [Advantage](2-Mechanics/CLI/rules/variant-rules/advantage-xphb.md) on the roll. In addition, your target gains no benefit from [Half Cover](2-Mechanics/CLI/rules/variant-rules/cover-xphb.md) or [Three-Quarters Cover](2-Mechanics/CLI/rules/variant-rules/cover-xphb.md), and you suffer no [Disadvantage](2-Mechanics/CLI/rules/variant-rules/disadvantage-xphb.md) due to long range. If the attack hits, your sworn enemy takes an extra `3d6` Piercing damage.

While your sworn enemy lives, you have [Disadvantage](2-Mechanics/CLI/rules/variant-rules/disadvantage-xphb.md) on attack rolls with all other weapons.
