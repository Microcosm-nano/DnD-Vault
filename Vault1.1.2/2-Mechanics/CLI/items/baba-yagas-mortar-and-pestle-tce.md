...
![](2-Mechanics/CLI/items/img/baba-yagas-mortar-and-pestle.webp#right)
...
You can also use the artifact as [alchemist's supplies](2-Mechanics/CLI/items/alchemists-supplies-xphb.md), [brewer's supplies](2-Mechanics/CLI/items/brewers-supplies-xphb.md), [cook's utensils](2-Mechanics/CLI/items/cooks-utensils-xphb.md), an [herbalism kit](2-Mechanics/CLI/items/herbalism-kit-xphb.md), and a [poisoner's kit](2-Mechanics/CLI/items/poisoners-kit-xphb.md). You have advantage on any check you make using the artifact as one of these tools.
