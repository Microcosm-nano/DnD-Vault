...
![](2-Mechanics/CLI/items/img/weapon-of-warning.webp#right)
...
Each subject has [Advantage](2-Mechanics/CLI/rules/variant-rules/advantage-xphb.md) on its [Initiative](2-Mechanics/CLI/rules/variant-rules/initiative-xphb.md) rolls.
