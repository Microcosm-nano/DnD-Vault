...
![](2-Mechanics/CLI/bestiary/giant/img/fire-giant-of-evil-fire.webp#right)
...
![](2-Mechanics/CLI/bestiary/giant/token/fire-giant-of-evil-fire-bgg.webp#token)
...
***Bolt of Imix.*** *Ranged Spell Attack:* `+8` to hit, range 120 ft., one target. *Hit:* 20 (`3d10 + 4`) fire damage, and the target must succeed on a DC 16 Wisdom saving throw or have the [frightened](2-Mechanics/CLI/rules/conditions.md#Frightened) condition until the end of the target's next turn.
```
^statblock