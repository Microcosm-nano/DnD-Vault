...
![](2-Mechanics/CLI/bestiary/giant/img/ettin.webp#right)
...
```ad-statblock
title: Ettin
![](2-Mechanics/CLI/bestiary/giant/token/ettin-xmm.webp#token)
...
***Battleaxe.*** *Melee Attack Roll:* `+7`, reach 5 ft. *Hit:* 14 (`2d8 + 5`) Slashing damage. If the target is a Large or smaller creature, it has the [Prone](2-Mechanics/CLI/rules/conditions.md#Prone) condition.

***Morningstar.*** *Melee Attack Roll:* `+7`, reach 5 ft. *Hit:* 14 (`2d8 + 5`) Piercing damage, and the target has [Disadvantage](2-Mechanics/CLI/rules/variant-rules/disadvantage-xphb.md) on the next attack roll it makes before the end of its next turn.
```
^statblock
