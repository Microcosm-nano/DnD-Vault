...
![](2-Mechanics/CLI/bestiary/giant/img/fomorian-deep-crawler.webp#right)
...
![](2-Mechanics/CLI/bestiary/giant/token/fomorian-deep-crawler-bgg.webp#token)
...
***Crawling Stance.*** While the fomorian has the [prone](2-Mechanics/CLI/rules/conditions.md#Prone) condition, crawling does not cost it extra movement. In addition, the [prone](2-Mechanics/CLI/rules/conditions.md#Prone) condition does not grant advantage on attack rolls against the fomorian.
...
***Crawling Hex (Recharge 4-6).*** The fomorian targets one creature it can see within 60 feet of itself. The target must succeed on a DC 15 Wisdom saving throw or take 31 (`7d8`) psychic damage, have the [prone](2-Mechanics/CLI/rules/conditions.md#Prone) condition, and become cursed for 1 hour. While cursed this way, the target can't stand up and end the [prone](2-Mechanics/CLI/rules/conditions.md#Prone) condition on itself.
```
^statblock