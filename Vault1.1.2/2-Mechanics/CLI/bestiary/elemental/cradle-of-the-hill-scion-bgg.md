...
![](2-Mechanics/CLI/bestiary/elemental/token/cradle-of-the-hill-scion-bgg.webp#token)
...
***Spit Rock.*** *Ranged Weapon Attack:* `+14` to hit, range 120 ft., one target. *Hit:* 25 (`4d8 + 7`) bludgeoning damage, and the target must succeed on a DC 22 Strength saving throw or have the [prone](2-Mechanics/CLI/rules/conditions.md#Prone) condition.
...
***Rolling Hills (Recharge 6).*** The cradle magically creates a wave of dirt that extends from a point on the ground within 120 feet of itself. The wave is up to 30 feet long, up to 30 feet tall, and up to 30 feet wide. Each creature in the wave must make a DC 22 Strength saving throw. On a failed save, a creature takes 58 (`9d12`) bludgeoning damage, has the [prone](2-Mechanics/CLI/rules/conditions.md#Prone) condition, and is buried under dirt. On a successful save, a creature takes half as much damage only.
