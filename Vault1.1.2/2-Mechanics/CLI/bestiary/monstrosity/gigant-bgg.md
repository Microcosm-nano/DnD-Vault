...
![](2-Mechanics/CLI/bestiary/monstrosity/img/gigant.webp#right)
...
```ad-statblock
title: Gigant
![](2-Mechanics/CLI/bestiary/monstrosity/token/gigant-bgg.webp#token)
...
***Drone.*** The gigant produces a horrid droning sound by rapidly beating its wings. Each creature within 10 feet of the gigant must succeed on a DC 19 Constitution saving throw or take 10 (`3d6`) thunder damage and have the [incapacitated](2-Mechanics/CLI/rules/conditions.md#Incapacitated) condition until the end of its next turn. The gigant can then fly up to half its flying speed.
```
^statblock