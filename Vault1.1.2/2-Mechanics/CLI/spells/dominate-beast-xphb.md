...
**Using a Higher-Level Spell Slot.** Your [Concentration](2-Mechanics/CLI/rules/conditions.md#Concentration) can last longer with a spell slot of level 5 (up to 10 minutes), 6 (up to 1 hour), or 7+ (up to 8 hours).

**Classes**: [Druid](2-Mechanics/CLI/lists/list-spells-classes-druid.md); [Paladin (Oath of Conquest)](2-Mechanics/CLI/lists/list-spells-classes-paladin-xphb-oath-of-conquest-xge.md "subclass=XGE;class=XPHB"); [Warlock (Archfey Patron)](2-Mechanics/CLI/lists/list-spells-classes-warlock-xphb-archfey-patron-xphb.md "subclass=XPHB;class=XPHB"); [Bard](2-Mechanics/CLI/lists/list-spells-classes-bard.md); [Ranger](2-Mechanics/CLI/lists/list-spells-classes-ranger.md); [Sorcerer](2-Mechanics/CLI/lists/list-spells-classes-sorcerer.md)
