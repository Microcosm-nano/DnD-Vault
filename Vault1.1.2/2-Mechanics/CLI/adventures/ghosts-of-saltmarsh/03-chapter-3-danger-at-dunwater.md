...
| 26 | 5 [giant poisonous snakes](2-Mechanics/CLI/bestiary/beast/giant-venomous-snake-xmm.md) | The snakes remain here. |
...
The five [lizardfolk commoners](2-Mechanics/CLI/bestiary/humanoid/lizardfolk-commoner-gos.md) (see appendix C) fight only if they are cornered. Otherwise, they escape to the nearest barracks (area 9), whose occupants return to the kitchen in the shortest possible time.
...
![](2-Mechanics/CLI/adventures/ghosts-of-saltmarsh/img/026-03-05-nursery-p77.webp#center)
...
Unless extreme circumstances prevail (for example, the guards in area 32 have beaten a fighting retreat here), two [lizardfolk commoners](2-Mechanics/CLI/bestiary/humanoid/lizardfolk-commoner-gos.md) (see appendix C) reside here, playing a game at the table.
...
[Sauriv](2-Mechanics/CLI/bestiary/npc/sauriv-gos.md) has the statistics of a lizardfolk [noble](2-Mechanics/CLI/bestiary/humanoid/noble-xmm.md), with these changes:
...
The book on the table, *Power Politics* by Abel Mackie, is written in Common. It discusses the trickier and more devious side of political life. It can be sold for 5 gp.
...
Four [lizardfolk](2-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) hide in the seaweed of the pool.
...
- There would be no violation of sacred taboo if the adventurers were to kill the giant crocodile on the queen's behalf. In fact, the queen demands the head of [Thousand Teeth](2-Mechanics/CLI/bestiary/npc/thousand-teeth-gos.md) be brought to her so that she might add it to her collection.  

If the party agrees to solve the tribe's crocodile problem, Queen [Othokent](2-Mechanics/CLI/bestiary/npc/othokent-gos.md) offers them a vile-tasting flask of swamp water mashed with various roots (a [potion of superior healing](2-Mechanics/CLI/items/potion-of-superior-healing-xdmg.md)).

### Lair of the Devourer

[Thousand Teeth](2-Mechanics/CLI/bestiary/npc/thousand-teeth-gos.md)'s pool is located along the Dunwater River, about twelve miles inland from the lizardfolk lair.
...
| dice: d8 | Result |
|----------|--------|
| 1 | 6 hungry [giant frogs](2-Mechanics/CLI/bestiary/beast/giant-frog-xmm.md) |
| 2 | 1 [troll](2-Mechanics/CLI/bestiary/giant/troll-xmm.md) eating crabs |
| 3 | 2 [cult fanatics](2-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) performing a ritual |
| 4 | 3 [swarms of insects (wasps)](2-Mechanics/CLI/bestiary/beast/swarm-of-insects-xmm.md) defending their nest |
| 5 | 1 [druid](2-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) (evil-aligned) and two [swarms of rats](2-Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm.md) |
| 6 | 4 [lizardfolk](2-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) (not from the queen's lair) |
| 7 | 1 injured (half hit points) [treant](2-Mechanics/CLI/bestiary/plant/treant-xmm.md) beset by 6 [swarms of rats](2-Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm.md) |
| 8 | 2 [ogres](2-Mechanics/CLI/bestiary/giant/ogre-xmm.md), lost in the marsh |
^marsh-random-encounters

While traveling through the marsh, the characters also likely encounter one or more of the hazards presented in the "Hazards in the Marsh" sidebar at the beginning of this adventure.

##### Following the Riverbank

The river snakes through the marsh for nearly twenty miles before arriving at [Thousand Teeth](2-Mechanics/CLI/bestiary/npc/thousand-teeth-gos.md)'s pool. The riverbank is difficult terrain, and following it from the lizardfolk lair to the pool takes 13 hours (at normal pace). The riverbank route offers a better chance of avoiding random encounters. For every 3 hours the characters travel along the riverbank, they have a 50 percent chance of facing a random encounter.
...
![Thousand Teeth](2-Mechanics/CLI/adventures/ghosts-of-saltmarsh/img/029-03-08-thousand-teeth-p85.webp#center)

The pool is 8 feet deep at its center. The water is polluted from the rotting remains of [Thousand Teeth](2-Mechanics/CLI/bestiary/npc/thousand-teeth-gos.md)'s meals, and any creature that ingests more than a spoonful must succeed on a DC 12 Constitution saving throw or be [poisoned](2-Mechanics/CLI/rules/conditions.md#Poisoned) for 1 hour.

In addition to [Thousand Teeth](2-Mechanics/CLI/bestiary/npc/thousand-teeth-gos.md) (see appendix C) in its muddy mound, two [giant constrictor snakes](2-Mechanics/CLI/bestiary/beast/giant-constrictor-snake-xmm.md) lurk in the canopy of vines and drop down on unsuspecting creatures that linger too long at the pool's edge. A character who has a passive Perception score of 15 or more notices the snakes before they attack.

##### Development

[Thousand Teeth](2-Mechanics/CLI/bestiary/npc/thousand-teeth-gos.md) currently sleeps in its muddy mound. Its nose is nearly invisible where it pokes above the water. If any creature enters its pool, or if loud sounds are made near the pool's edge (such as combat with giant snakes), the crocodile awakens and slides through the water to investigate. If it does interrupt combat with the canopy-dwelling serpents, the snakes flee into the trees to escape.