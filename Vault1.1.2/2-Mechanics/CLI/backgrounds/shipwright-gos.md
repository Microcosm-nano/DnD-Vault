...
- **Tool Proficiencies.** [Carpenter's tools](2-Mechanics/CLI/items/carpenters-tools-xphb.md), Vehicles (water)  
- **Equipment.** A set of well-loved [carpenter's tools](2-Mechanics/CLI/items/carpenters-tools-xphb.md), a blank [book](2-Mechanics/CLI/items/book-xphb.md), [1 ounce of ink](2-Mechanics/CLI/items/ink-xphb.md), an [ink pen](2-Mechanics/CLI/items/ink-pen-xphb.md), a set of [traveler's clothes](2-Mechanics/CLI/items/travelers-clothes-xphb.md), and a leather [pouch](2-Mechanics/CLI/items/pouch-xphb.md) with 10 gp  
