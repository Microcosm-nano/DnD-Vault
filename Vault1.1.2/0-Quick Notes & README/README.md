...
This is the original README from Josh P. It isn't as relevant for a viewer, but is important for me as an editor. Please support Josh P and the TTRPG Discord community if you can. They do amazing work and are very dedicated to helping others learn about this software and have fun playing TTRPGs :)
...
## Showing Hidden Files/Folders and Other Important Settings - From Mitch

**Much of the content in the file browser is hidden to reduce congestion in the file structure, and to discourage editing of critical files by users. As of  right now, I am unsure if it is hidden for you by default.**

Commands are input using **ctrl+p**

You can toggle the visibility status of the files and folders by running the  
`File Hider: Toggle Visibility` command.

### DO NOT ALTER  ANY HIDDEN FILES, OR 2-Mechanics UNLESS YOU KNOW WHAT YOU'RE DOING!