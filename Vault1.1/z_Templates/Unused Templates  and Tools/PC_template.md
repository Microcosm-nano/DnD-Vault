...
`VIEW[round(floor(({level}+7)/4),0)][math(hidden):prof]`
...
>> ||
>> |:---:|:---:|:---:|:---:|
>> | STR | `INPUT[number(class(nb-mb-35)):abilityScores.str]` | INT | `INPUT[number(class(nb-mb-35)):abilityScores.int]` |
>> | DEX | `INPUT[number(class(nb-mb-35)):abilityScores.dex]` | WIS | `INPUT[number(class(nb-mb-35)):abilityScores.wis]` |
>> | CON | `INPUT[number(class(nb-mb-35)):abilityScores.con]` | CHA | `INPUT[number(class(nb-mb-35)):abilityScores.cha]` |
