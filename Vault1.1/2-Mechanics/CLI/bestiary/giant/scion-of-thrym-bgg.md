...
![](2-Mechanics/CLI/bestiary/giant/img/scion-of-thrym.webp#right)
...
![](2-Mechanics/CLI/bestiary/giant/token/scion-of-thrym-bgg.webp#token)
...
***Glacier Throw.*** *Ranged Weapon Attack:* `+17` to hit, range 120/480 ft., one target. *Hit:* 36 (`4d12 + 10`) bludgeoning damage plus 14 (`4d6`) cold damage, and the target must succeed on a DC 25 Strength saving throw or have the [prone](2-Mechanics/CLI/rules/conditions.md#Prone) condition.
