...
![](2-Mechanics/CLI/bestiary/dragon/img/draconic-spirit.webp#center)

```ad-statblock
title: Draconic Spirit
![](2-Mechanics/CLI/bestiary/dragon/token/draconic-spirit-xphb.webp#token)
...
***Rend.*** *Melee Attack Roll:* `YourSpellAttack Bonus equals your spell attack modifier`, reach 10 feet. *Hit:* `1d6 + 4` + the spell's level Piercing damage.
