...
***Web Bolt.*** *Ranged Attack Roll:* `YourSpellAttack Bonus equals your spell attack modifier`, range 60 ft. *Hit:* `1d10 + 3` + the spell's level Bludgeoning damage, and the target's Speed is reduced to 0 until the start of the insect's next turn.
```
^statblock