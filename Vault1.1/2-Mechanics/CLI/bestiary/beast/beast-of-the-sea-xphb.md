...
![](2-Mechanics/CLI/bestiary/beast/img/beast-of-the-sea.webp#center)

```ad-statblock
title: Beast of the Sea
![](2-Mechanics/CLI/bestiary/beast/token/beast-of-the-sea-xphb.webp#token)
...
***Beast's Strike.*** *Melee Attack Roll:* `YourSpellAttack Bonus equals your spell attack modifier`, reach 5 ft. *Hit:* `1d6 + 2` plus your Wisdom modifier Bludgeoning or Piercing damage (your choice when you summon the beast), and the target has the [Grappled](2-Mechanics/CLI/rules/conditions.md#Grappled) condition (escape DC equals your spell save DC).
```
^statblock