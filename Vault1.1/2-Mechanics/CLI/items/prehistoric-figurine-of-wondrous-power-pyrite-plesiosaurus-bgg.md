...
This figurine becomes a [plesiosaurus](2-Mechanics/CLI/bestiary/beast/plesiosaurus-xmm.md) for up to 12 hours and can be ridden as a mount. Once it has been used, it can't be used again until 4 days have passed.

While you are riding the plesiosaurus, you can use it to cast [water breathing](2-Mechanics/CLI/spells/water-breathing-xphb.md) at will.
