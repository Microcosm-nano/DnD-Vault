...
You gain [darkvision](2-Mechanics/CLI/rules/senses.md#Darkvision) with a range of 60 feet, and you have advantage on Dexterity ([Stealth](2-Mechanics/CLI/rules/skills.md#Stealth)) checks.
