...
When you drink this potion, you gain the "reduce" effect of the [Enlarge/Reduce](2-Mechanics/CLI/spells/enlarge-reduce-xphb.md) spell for `1d4` hours (no [Concentration](2-Mechanics/CLI/rules/conditions.md#Concentration) required).
