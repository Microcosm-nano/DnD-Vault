...
![Trade Goods](2-Mechanics/CLI/tables/trade-goods-xdmg.md)
...
![10 GP Gemstones](2-Mechanics/CLI/tables/10-gp-gemstones-xdmg.md)

![50 GP Gemstones](2-Mechanics/CLI/tables/50-gp-gemstones-xdmg.md)

![100 GP Gemstones](2-Mechanics/CLI/tables/100-gp-gemstones-xdmg.md)

![500 GP Gemstones](2-Mechanics/CLI/tables/500-gp-gemstones-xdmg.md)

![1,000 GP Gemstones](2-Mechanics/CLI/tables/1000-gp-gemstones-xdmg.md)

![5,000 GP Gemstones](2-Mechanics/CLI/tables/5000-gp-gemstones-xdmg.md)
...
![25 GP Art Objects](2-Mechanics/CLI/tables/25-gp-art-objects-xdmg.md)

![250 GP Art Objects](2-Mechanics/CLI/tables/250-gp-art-objects-xdmg.md)

![750 GP Art Objects](2-Mechanics/CLI/tables/750-gp-art-objects-xdmg.md)

![2,500 GP Art Objects](2-Mechanics/CLI/tables/2500-gp-art-objects-xdmg.md)

![7,500 GP Art Objects](2-Mechanics/CLI/tables/7500-gp-art-objects-xdmg.md)
...
Unless its description notes otherwise, a wand can be used as an [Arcane Focus](2-Mechanics/CLI/items/arcane-focus-xphb.md).
...
![Magic Item Special Features; Magic Item's Creator or Intended User](2-Mechanics/CLI/tables/magic-item-special-features-magic-items-creator-or-intended-user-xdmg.md)

![Magic Item Special Features; Magic Item's History](2-Mechanics/CLI/tables/magic-item-special-features-magic-items-history-xdmg.md)

![Magic Item Special Features; Magic Item's Minor Property](2-Mechanics/CLI/tables/magic-item-special-features-magic-items-minor-property-xdmg.md)

![Magic Item Special Features; Magic Item's Quirk](2-Mechanics/CLI/tables/magic-item-special-features-magic-items-quirk-xdmg.md)

### Artifacts

![](2-Mechanics/CLI/books/dungeon-masters-guide-2024/img/108-07-005-magic-tome.webp#center)
...
![Artifact Properties; Minor Beneficial Properties](2-Mechanics/CLI/tables/artifact-properties-minor-beneficial-properties-xdmg.md)

![Artifact Properties; Major Beneficial Properties](2-Mechanics/CLI/tables/artifact-properties-major-beneficial-properties-xdmg.md)

![Artifact Properties; Minor Detrimental Properties](2-Mechanics/CLI/tables/artifact-properties-minor-detrimental-properties-xdmg.md)

![Artifact Properties; Major Detrimental Properties](2-Mechanics/CLI/tables/artifact-properties-major-detrimental-properties-xdmg.md)
...
![Special Purpose; Sentient Item's Alignment](2-Mechanics/CLI/tables/special-purpose-sentient-items-alignment-xdmg.md)

![Special Purpose; Sentient Item's Communication](2-Mechanics/CLI/tables/special-purpose-sentient-items-communication-xdmg.md)

![Special Purpose; Sentient Item's Senses](2-Mechanics/CLI/tables/special-purpose-sentient-items-senses-xdmg.md)

![Sentient Item's Special Purpose](2-Mechanics/CLI/tables/sentient-items-special-purpose-xdmg.md)
...
- Attempt to take control of its bearer, whereupon the bearer makes a Charisma saving throw (DC 12 plus the item's Charisma modifier). On a failed save, the bearer has the [Charmed](2-Mechanics/CLI/rules/conditions.md#Charmed) condition for `1d12` hours. While Charmed in this way, the bearer must try to follow the item's commands. If the bearer takes damage, it repeats the save, ending the effect on a success. Whether or not the attempt to control its bearer succeeds, the item can't use this power again until the next dawn.  

## Magic Items A-Z

Magic items are presented in alphabetical order.

If a magic item description capitalizes a creature's name and presents it in **bold** type, that's a visual cue pointing you to the creature's stat block. Unless the text states otherwise, the stat block is in the "Monster Manual". How to read and use a [stat block](2-Mechanics/CLI/rules/variant-rules/stat-block-xphb.md) is explained in the "Monster Manual" and to a lesser degree in the "Player's Handbook".

- [Adamantine Armor](2-Mechanics/CLI/items/adamantine-armor-xdmg.md)  
- [Adamantine Weapon](2-Mechanics/CLI/items/adamantine-weapon-xdmg.md)  
- [Alchemy Jug](2-Mechanics/CLI/items/alchemy-jug-xdmg.md)  
- [+1 Ammunition](2-Mechanics/CLI/items/1-ammunition-xdmg.md)  
- [+2 Ammunition](2-Mechanics/CLI/items/2-ammunition-xdmg.md)  
- [+3 Ammunition](2-Mechanics/CLI/items/3-ammunition-xdmg.md)  
- [Ammunition of Slaying](2-Mechanics/CLI/items/ammunition-of-slaying-xdmg.md)  
- [Amulet of Health](2-Mechanics/CLI/items/amulet-of-health-xdmg.md)  
- [Amulet of Proof Against Detection and Location](2-Mechanics/CLI/items/amulet-of-proof-against-detection-and-location-xdmg.md)  
- [Amulet of the Planes](2-Mechanics/CLI/items/amulet-of-the-planes-xdmg.md)  
- [Animated Shield](2-Mechanics/CLI/items/animated-shield-xdmg.md)  
- [Apparatus of Kwalish](2-Mechanics/CLI/items/apparatus-of-kwalish-xdmg.md)  
- [+1 Armor](2-Mechanics/CLI/items/1-armor-xdmg.md)  
- [+2 Armor](2-Mechanics/CLI/items/2-armor-xdmg.md)  
- [+3 Armor](2-Mechanics/CLI/items/3-armor-xdmg.md)  
- [Armor of Gleaming](2-Mechanics/CLI/items/armor-of-gleaming-xdmg.md)  
- [Armor of Invulnerability](2-Mechanics/CLI/items/armor-of-invulnerability-xdmg.md)  
- [Armor of Resistance](2-Mechanics/CLI/items/armor-of-resistance-xdmg.md)  
- [Armor of Vulnerability](2-Mechanics/CLI/items/armor-of-vulnerability-xdmg.md)  
- [Arrow-Catching Shield](2-Mechanics/CLI/items/arrow-catching-shield-xdmg.md)  
- [Axe of the Dwarvish Lords](2-Mechanics/CLI/items/axe-of-the-dwarvish-lords-xdmg.md)  
- [Baba Yaga's Dancing Broom](2-Mechanics/CLI/items/baba-yagas-dancing-broom-xdmg.md)  
- [Bag of Beans](2-Mechanics/CLI/items/bag-of-beans-xdmg.md)  
...
- [Dimensional Shackles](2-Mechanics/CLI/items/dimensional-shackles-xdmg.md)  
...
- [Ioun Stone](2-Mechanics/CLI/items/ioun-stone-xdmg.md)  
...
- [Potion of Invulnerability](2-Mechanics/CLI/items/potion-of-invulnerability-xdmg.md)  
...
- [Shield of Missile Attraction](2-Mechanics/CLI/items/shield-of-missile-attraction-xdmg.md)  
...
- [Wand of Paralysis](2-Mechanics/CLI/items/wand-of-paralysis-xdmg.md)  
- [Wand of Polymorph](2-Mechanics/CLI/items/wand-of-polymorph-xdmg.md)  
- [Wand of Pyrotechnics](2-Mechanics/CLI/items/wand-of-pyrotechnics-xdmg.md)  
- [Wand of Secrets](2-Mechanics/CLI/items/wand-of-secrets-xdmg.md)  
- [Wand of the War Mage](2-Mechanics/CLI/items/wand-of-the-war-mage-xdmg.md)  
- [Wand of Web](2-Mechanics/CLI/items/wand-of-web-xdmg.md)  
- [Wand of Wonder](2-Mechanics/CLI/items/wand-of-wonder-xdmg.md)  
- [Wave](2-Mechanics/CLI/items/wave-xdmg.md)  
- [+1 Weapon](2-Mechanics/CLI/items/1-weapon-xdmg.md)  
- [+2 Weapon](2-Mechanics/CLI/items/2-weapon-xdmg.md)  
- [+3 Weapon](2-Mechanics/CLI/items/3-weapon-xdmg.md)  
- [Weapon of Warning](2-Mechanics/CLI/items/weapon-of-warning-xdmg.md)  
- [Well of Many Worlds](2-Mechanics/CLI/items/well-of-many-worlds-xdmg.md)  
- [Whelm](2-Mechanics/CLI/items/whelm-xdmg.md)  
- [Wind Fan](2-Mechanics/CLI/items/wind-fan-xdmg.md)  
- [Winged Boots](2-Mechanics/CLI/items/winged-boots-xdmg.md)  
- [Wings of Flying](2-Mechanics/CLI/items/wings-of-flying-xdmg.md)  
- [Wraps of Unarmed Power](2-Mechanics/CLI/items/wraps-of-unarmed-power-xdmg.md)  
...
![Arcana - Common](2-Mechanics/CLI/tables/arcana-common-xdmg.md)

![Arcana - Uncommon](2-Mechanics/CLI/tables/arcana-uncommon-xdmg.md)

![Arcana - Rare](2-Mechanics/CLI/tables/arcana-rare-xdmg.md)

![Arcana - Very Rare](2-Mechanics/CLI/tables/arcana-very-rare-xdmg.md)

![Arcana - Legendary](2-Mechanics/CLI/tables/arcana-legendary-xdmg.md)

### Armaments Tables

![Armaments - Common](2-Mechanics/CLI/tables/armaments-common-xdmg.md)

![Armaments - Uncommon](2-Mechanics/CLI/tables/armaments-uncommon-xdmg.md)

![Armaments - Rare](2-Mechanics/CLI/tables/armaments-rare-xdmg.md)

![Armaments - Very Rare](2-Mechanics/CLI/tables/armaments-very-rare-xdmg.md)

![Armaments - Legendary](2-Mechanics/CLI/tables/armaments-legendary-xdmg.md)

### Implements Tables

![Implements - Common](2-Mechanics/CLI/tables/implements-common-xdmg.md)

![Implements - Uncommon](2-Mechanics/CLI/tables/implements-uncommon-xdmg.md)

![Implements - Rare](2-Mechanics/CLI/tables/implements-rare-xdmg.md)

![Implements - Very Rare](2-Mechanics/CLI/tables/implements-very-rare-xdmg.md)

![Implements - Legendary](2-Mechanics/CLI/tables/implements-legendary-xdmg.md)

### Relics Tables

![Relics - Common](2-Mechanics/CLI/tables/relics-common-xdmg.md)

![Relics - Uncommon](2-Mechanics/CLI/tables/relics-uncommon-xdmg.md)

![Relics - Rare](2-Mechanics/CLI/tables/relics-rare-xdmg.md)

![Relics - Very Rare](2-Mechanics/CLI/tables/relics-very-rare-xdmg.md)

![Relics - Legendary](2-Mechanics/CLI/tables/relics-legendary-xdmg.md)