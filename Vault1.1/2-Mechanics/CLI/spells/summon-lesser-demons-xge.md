...
The DM chooses the demons, such as [manes](2-Mechanics/CLI/bestiary/fiend/manes-xmm.md) or [dretches](2-Mechanics/CLI/bestiary/fiend/dretch-xmm.md), and you choose the unoccupied spaces you can see within range where they appear. A summoned demon disappears when it drops to 0 hit points or when the spell ends.
