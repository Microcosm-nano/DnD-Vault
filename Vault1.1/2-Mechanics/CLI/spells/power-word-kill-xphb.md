...
You compel one creature you can see within range to die. If the target has 100 [Hit Points](2-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md) or fewer, it dies. Otherwise, it takes `12d12` Psychic damage.
