...
|-----------|-----------------------|
| 1 | `2d10` [sahuagin](2-Mechanics/CLI/bestiary/fiend/sahuagin-warrior-xmm.md) |
| 2 | 1 [giant octopus](2-Mechanics/CLI/bestiary/beast/giant-octopus-xmm.md) |
| 3 | `1d4 + 1` [chuuls](2-Mechanics/CLI/bestiary/aberration/chuul-xmm.md) |
| 4 | 1 [sea hag](2-Mechanics/CLI/bestiary/fey/sea-hag-xmm.md) and `2d4` [merrow](2-Mechanics/CLI/bestiary/monstrosity/merrow-xmm.md) |
| 5 | 1 [plesiosaurus](2-Mechanics/CLI/bestiary/beast/plesiosaurus-xmm.md) |
| 6 | `1d4` [swarms of quippers](2-Mechanics/CLI/bestiary/beast/swarm-of-piranhas-xmm.md) |
| 7 | `2d4` [reef sharks](2-Mechanics/CLI/bestiary/beast/reef-shark-xmm.md) |
| 8 | 1 [giant shark](2-Mechanics/CLI/bestiary/beast/giant-shark-xmm.md) |
...
The souls of the dead want the living to join them. Every hour a ship is immersed in ghost fog, roll any die. On an even number, `2d4` hostile [specters](2-Mechanics/CLI/bestiary/undead/specter-xmm.md) appear and attack those on the ship. If a humanoid creature dies in ghost fog, its spirit rises as a specter that is hostile toward all creatures that aren't undead.
...
When conjuration magic churns within a storm's heart, creatures of wind and rain emerge from distant realms to attack anything they encounter. The ship encounters `1d3` hostile [air elementals](2-Mechanics/CLI/bestiary/elemental/air-elemental-xmm.md).
...
Ghosts howl and whirl in this storm's wind, while the remains of long-dead mariners stir in their watery graves. During the storm, `1d4` [specters](2-Mechanics/CLI/bestiary/undead/specter-xmm.md), `2d4` [ghouls](2-Mechanics/CLI/bestiary/undead/ghoul-xmm.md), and `4d6` [zombies](2-Mechanics/CLI/bestiary/undead/zombie-xmm.md) emerge from the waves to attack the ship.
...
| dice: d10 | Creatures or Treasure |
|-----------|-----------------------|
| 1 | 1 [sahuagin priestess](2-Mechanics/CLI/bestiary/fiend/sahuagin-priest-xmm.md) and `2d10` [sahuagin](2-Mechanics/CLI/bestiary/fiend/sahuagin-warrior-xmm.md) |
| 2 | 1 [young bronze dragon](2-Mechanics/CLI/bestiary/dragon/young-bronze-dragon-xmm.md) |
| 3 | `4d10` [giant crabs](2-Mechanics/CLI/bestiary/beast/giant-crab-xmm.md) |
| 4 | `3d10` [giant seahorses](2-Mechanics/CLI/bestiary/beast/giant-seahorse-xmm.md) |
| 5 | `1d4` [hunter sharks](2-Mechanics/CLI/bestiary/beast/hunter-shark-xmm.md) |
| 6 | 1 [giant octopus](2-Mechanics/CLI/bestiary/beast/giant-octopus-xmm.md) |
| 7 | `2d6` [merrow](2-Mechanics/CLI/bestiary/monstrosity/merrow-xmm.md) |
| 8 | `2d10` [merfolk](2-Mechanics/CLI/bestiary/elemental/merfolk-skirmisher-xmm.md) |
