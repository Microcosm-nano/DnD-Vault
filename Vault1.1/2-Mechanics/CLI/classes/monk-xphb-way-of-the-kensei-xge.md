...
- **Agile Parry**  
    ...
    If you make an unarmed strike as part of the [Attack](2-Mechanics/CLI/rules/actions.md#Attack) action on your turn and are holding a kensei weapon, you can use it to defend yourself if it is a melee weapon. You gain a +2 bonus to AC until the start of your next turn, while the weapon is in your hand and you aren't [incapacitated](2-Mechanics/CLI/rules/conditions.md#Incapacitated).  
...
You gain proficiency with your choice of [calligrapher's supplies](2-Mechanics/CLI/items/calligraphers-supplies-xphb.md) or [painter's supplies](2-Mechanics/CLI/items/painters-supplies-xphb.md).
